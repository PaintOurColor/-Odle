// Get the modal
var post_search_modal = document.getElementById('post_search_modal');

// When the user clicks on the button, open the modal 
function open_post_search_popup(post_id) {
    post_search_modal.style.display = "block";
    get_post(post_id);
}

// When the user clicks on <span> (x), close the modal
function close_button() {
    post_search_modal.style.display = "none";
}

// When the user clicks anywhere outside of the modal, close it
window.onclick = function (event) {
    if (event.target === post_search_modal) {
        post_search_modal.style.display = "none";
    }
}
...
function get_post(post_id) {
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#post_search_popup').append(temp_post);
...
function like_post(post_id) {
    $.ajax({
        ...
        success: function (response) {
            close_button()
            open_post_search_popup(post_id)
        },
